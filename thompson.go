...
func poregToNfa(postfix string) *nfa {
	...
	for _, r := range postfix {
		...
		case '|': // The Alternation Operator (union/or) - N|M
			...
			frag2.accept.edge2 = &accept // join the accept state of fragment 2 to the final accept state
		...
		case '+': // The Match-one-or-more Operator
		case '?': // The Match-zero-or-one Operator	
		case '^': // The Match-beginning-of-line Operator
		case '$': // The Match-end-of-line Operator
